...
#doc (Manual) "`m/v/test-projects/literate-config/LitConfig/`"  =>
...
{include «Vtd_mods».«Vtd_verso».«Vtd_test-projects».«Vtd_literate-config».«Vtd_LitConfig».«Vtd_Core.lean»}
{include «Vtd_mods».«Vtd_verso».«Vtd_test-projects».«Vtd_literate-config».«Vtd_LitConfig».«Vtd_NoDocstrings.lean»}
