...
#doc (Manual) "`mods/verso/src/verso-manual/VersoManual/Html`"  =>
...
# Files in `mods/verso/src/verso-manual/VersoManual/Html`
%%%
tag := "mods/verso/src/verso-manual/VersoManual/Html-files"
%%%
