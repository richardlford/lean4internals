...
#doc (Manual) "`mods/verso/vendored-js/katex/contrib`"  =>
...
# Files in `mods/verso/vendored-js/katex/contrib`
%%%
...
: `mhchem.min.js`
  ...
  [source](vscode:/home/fordrl/e/lean4internals/mods/verso/vendored-js/katex/contrib/mhchem.min.js)TODO
