-- /home/fordrl/e/lean4internals/books/lean4top/Vtd_lean4/Vtd_stage0/Vtd_src/Vtd_library.lean
        

-- Imports from child directories.

import «Vtd_lean4».«Vtd_stage0».«Vtd_src».«Vtd_library».«Vtd_constructions»
...
#doc (Manual) "`lean4/stage0/src/library`"  =>

%%%
authors := ["Richard L Ford"]
tag := "lean4/stage0/src/library"
%%%

TODO


{include «Vtd_lean4».«Vtd_stage0».«Vtd_src».«Vtd_library».«Vtd_constructions»}

# Files in `lean4/stage0/src/library`
%%%
tag := "lean4/stage0/src/library-files"
%%%
