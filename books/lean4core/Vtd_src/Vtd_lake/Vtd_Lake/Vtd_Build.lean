-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_lake/Vtd_Lake/Vtd_Build.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_lake».«Vtd_Lake».«Vtd_Build».«Vtd_Target»
import «Vtd_src».«Vtd_lake».«Vtd_Lake».«Vtd_Build».«Vtd_Job»
...
#doc (Manual) "`src/lake/Lake/Build`"  =>

%%%
authors := ["Richard L Ford"]
tag := "src/lake/Lake/Build"
%%%

TODO


{include «Vtd_src».«Vtd_lake».«Vtd_Lake».«Vtd_Build».«Vtd_Target»}
{include «Vtd_src».«Vtd_lake».«Vtd_Lake».«Vtd_Build».«Vtd_Job»}

# Files in `src/lake/Lake/Build`
%%%
tag := "src/lake/Lake/Build-files"
%%%
