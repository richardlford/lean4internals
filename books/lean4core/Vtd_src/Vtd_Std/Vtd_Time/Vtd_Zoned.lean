-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Std/Vtd_Time/Vtd_Zoned.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_Std».«Vtd_Time».«Vtd_Zoned».«Vtd_Database»
...
#doc (Manual) "`src/Std/Time/Zoned`"  =>

%%%
authors := ["Richard L Ford"]
tag := "src/Std/Time/Zoned"
%%%

TODO


{include «Vtd_src».«Vtd_Std».«Vtd_Time».«Vtd_Zoned».«Vtd_Database»}

# Files in `src/Std/Time/Zoned`
%%%
tag := "src/Std/Time/Zoned-files"
%%%
