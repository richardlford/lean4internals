-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Lean/Vtd_Meta.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Match»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_ArgsPacker»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_DiscrTree»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Constructions»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Sym»
...
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Match»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_ArgsPacker»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_DiscrTree»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Constructions»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Sym»}

# Files in `src/Lean/Meta`
%%%
tag := "src/Lean/Meta-files"
%%%
