-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Lean/Vtd_Elab.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Term»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_PreDefinition»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Do»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Quotation»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_BuiltinDo»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Tactic»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Command»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_InfoTree»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_DocString»
import «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Deriving»
...
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Term»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_PreDefinition»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Do»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Quotation»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_BuiltinDo»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Tactic»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Command»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_InfoTree»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_DocString»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Elab».«Vtd_Deriving»}

# Files in `src/Lean/Elab`
%%%
tag := "src/Lean/Elab-files"
%%%
