-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Lean/Vtd_Compiler/Vtd_LCNF.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_Lean».«Vtd_Compiler».«Vtd_LCNF».«Vtd_Simp»
...
#doc (Manual) "`src/Lean/Compiler/LCNF`"  =>

%%%
authors := ["Richard L Ford"]
tag := "src/Lean/Compiler/LCNF"
%%%

TODO


{include «Vtd_src».«Vtd_Lean».«Vtd_Compiler».«Vtd_LCNF».«Vtd_Simp»}

# Files in `src/Lean/Compiler/LCNF`
%%%
tag := "src/Lean/Compiler/LCNF-files"
%%%
