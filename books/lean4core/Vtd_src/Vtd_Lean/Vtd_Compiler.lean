-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Lean/Vtd_Compiler.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_Lean».«Vtd_Compiler».«Vtd_LCNF»
import «Vtd_src».«Vtd_Lean».«Vtd_Compiler».«Vtd_IR»
...
#doc (Manual) "`src/Lean/Compiler`"  =>

%%%
authors := ["Richard L Ford"]
tag := "src/Lean/Compiler"
%%%

TODO


{include «Vtd_src».«Vtd_Lean».«Vtd_Compiler».«Vtd_LCNF»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Compiler».«Vtd_IR»}

# Files in `src/Lean/Compiler`
%%%
tag := "src/Lean/Compiler-files"
%%%
