-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Lean/Vtd_Meta/Vtd_Tactic/Vtd_Grind.lean
        

-- Imports from child directories.

import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic».«Vtd_Grind».«Vtd_AC»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic».«Vtd_Grind».«Vtd_Order»
import «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic».«Vtd_Grind».«Vtd_Arith»
...
#doc (Manual) "`src/Lean/Meta/Tactic/Grind`"  =>

%%%
authors := ["Richard L Ford"]
tag := "src/Lean/Meta/Tactic/Grind"
%%%

TODO


{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic».«Vtd_Grind».«Vtd_AC»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic».«Vtd_Grind».«Vtd_Order»}
{include «Vtd_src».«Vtd_Lean».«Vtd_Meta».«Vtd_Tactic».«Vtd_Grind».«Vtd_Arith»}

# Files in `src/Lean/Meta/Tactic/Grind`
%%%
tag := "src/Lean/Meta/Tactic/Grind-files"
%%%
