-- /home/fordrl/e/lean4internals/books/lean4core/Vtd_src/Vtd_Lean/Vtd_DocString.lean
...
#doc (Manual) "`src/Lean/DocString`"  =>

%%%
authors := ["Richard L Ford"]
tag := "src/Lean/DocString"
%%%

TODO


# Files in `src/Lean/DocString`
%%%
tag := "src/Lean/DocString-files"
%%%
